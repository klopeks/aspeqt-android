...
private:
    ...
    QWidget *diskRowContainers[g_numberOfDisks];
    QLabel *mountedFileLabels[g_numberOfDisks];
    ...
    QTranslator aspeqt_translator, aspeqt_qt_translator, aspeqt_qtbase_translator;
    ...
    void prepareForXexBoot();
    void restartForXexOpen();
    void restartForCassetteOpen();
    void chooseAndBootExe();
    ...
    void setupAndroidDiskFileLabels();
    void updateMountedFileLabel(int no, const QString &text, const QString &styleSheet,
                                const QString &toolTip = QString(),
                                const QString &statusTip = QString());
    bool chooseCassetteEngine(const QString &fileName, CassettePlaybackEngine &engine);
    void playCassetteImage(const QString &fileName);
