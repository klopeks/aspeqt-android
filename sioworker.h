...
enum CassettePlaybackEngine
{
    CassettePlaybackStandard = 0,
    CassettePlaybackFskCompatibility = 1
};
...
public:
    ...
    static bool inspectCasImage(const QString &fileName, bool *containsFsk = nullptr, QString *errorMessage = nullptr);
    bool loadCasImage(const QString &fileName, CassettePlaybackEngine engine = CassettePlaybackStandard);
